...
function colors.generate()
    ...
    elseif vim.g.neon_style == "my_style" then
        colors.fg = "#C8CCCE"
        --colors.bg0 = "#222223"
        colors.bg0 = "#2A2D37"
        colors.bg1 = "#969696"
	...
	colors.bg3 = "#a0a1a7"
        ...
        colors.dark_cyan = "#5699AF"
        colors.blue = "#006c9e"
        colors.violet = "#5857ff"
        colors.purple = "#a626a4"
        colors.light_blue = "#00afff"
        colors.light_sky_blue = "#87afaf"
        colors.light_pink = "#d787af"
        colors.light_green = "#87af87"
        colors.disabled = "#676E95"
        colors.diff_red = "#55393d"
        colors.diff_green = "#394634"
        colors.diff_blue = "#354157"
        colors.diff_yellow = "#AC9C59"
    end
end
